 ...
 * @param  {Object} data Cache test results object
 * @return {Object} Action object
 */
export const receiveResults = ( siteId, data ) => ( { type: WP_SUPER_CACHE_RECEIVE_TEST_CACHE_RESULTS, siteId, data } );
...
export const testCache = ( siteId, httpOnly ) => {
	return ( dispatch ) => {
		...
		return wp.req.post( { path: `/jetpack-blogs/${ siteId }/rest-api/` }, {}, { path: '/wp-super-cache/v1/cache/test', httpOnly } )
			.then( ( { data } ) => {
